...
@section('description', '予約ページの編集画面です。編集をしたい予約の「基本情報」「日時・定員数」をクリックして編集を行ってください。「表示」をクリックすると予約ページが表示され、「削除」をクリックすると予約ページが削除されます。')
        ...
        <div class="member-top-body">
            ...
            <div class="tab-content">
                ...
                <div @if($private["private"] == 1) class="tab-pane fade show active" @else class="tab-pane fade" @endif id="release">
                    ...
                    <!-- 一つでも公開中の予約ページがある場合 -->
                    @else
                        <p class="edit-p">「基本情報」「日時・定員数」をクリックして編集を行ってください。</p>
