        ...
        <section class="m-container">
            <div class="explanation">
                ...
                <article class="createpage-conts">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p>「日にち」をクリックするとカレンダーが表示され、予約ページ作成時に設定した日にちが選択できるようになっています。<br>
                ...
                <article class="createpage-conts">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="orange-dotted"></div>
                            <p>「時間」をクリックすると、選択した日にちに予約可能な時間のみが選択できるようになっています。<br>
                ...
                <article>
                    ...
                    <p>「お客様情報」ページでは、予約をされる方の「お名前」「お名前（フリガナ）」「電話番号」「メールアドレス」を入力していただきます。ここで入力していただいた情報が顧客情報となり、管理画面で確認することができます。<br>
                ...
                <article>
                    ...
                    予約に関してのお問い合わせ先として、ヨヤクマの会員登録時に設定した「企業名・屋号名・団体名」「電話番号」「メールアドレス」が反映されます。</p>
                </article>
        ...
        <section class="m-container edit-s-2">
            <div class="explanation">
                ...
                <article class="incase">
                    ...
                    <p>複数の方が同時に予約をしようとした際に、万が一、予約フォームを入力中に定員に達してしまった場合は、「内容確認」ページの「予約する」ボタンをクリックした際に、「※コチラの予約は定員に達しました。」と表記され、予約がされない仕様となっております。</p>
