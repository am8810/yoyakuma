...
@section('content')
    ...
    <div class="top-gray-stripe">
        ...
        <section class="under-performance s-container">
            ...
            <p>ヨヤクマの予約ページが、どのように作成されるかをご説明します。予約ページ作成は、どなたでも簡単に設定が行えるよう、項目を見やすくし、カレンダーを直接クリックして行う仕様となっております。</p>
        </section>
        ...
        <section class="m-container">
            <div class="explanation">
                ...
                <article>
                    <h3>予約価格</h3>
                    <div class="orange-dotted"></div>
                    <p>1人あたりの予約価格を入力します。無料の場合は0と入力すると、予約ページには「無料」と表示されます。予約時に価格は決まっておらず、現地で算定される場合は「予約時に価格は算定されません」にチェックを入れてください。</p>
                </article>

                <article>
                    <h3>日時・人数の変更について</h3>
                    <div class="orange-dotted"></div>
                    <p>予約をされた方から、日時・人数の変更のご要望があった際に、どのようにご対応されるか、任意の文章をご入力ください。</p>
                </article>
                
                <article>
                    <h3>キャンセルについて</h3>
                    <div class="orange-dotted"></div>
                    <p>予約をされた方から、予約キャンセルのご要望があった際に、何日前まではキャンセル料は無料で、何日まえからはキャンセル料が発生するといったことを任意の文章でご入力ください。</p>
                    <table>
                      <tbody>
                          <tr>
                              <td>※</td>
                ...
                <article id="reception">
                    ...
                    複数のアドレスで受信する場合は、「追加」をクリックしてください。</p>
