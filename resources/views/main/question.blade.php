...
@section('content')
    ...
    <section class="m-container">
        ...
        <div class="menu question-a">
          ...
          <ul id="links01">
            <li><span class="answer">Ａ</span>　ヨヤクマは、ご自身で予約ページの作成・編集をして、インターネット上で予約を受けることが可能になる予約管理システムです。管理画面上で予約状況の把握や、予約人数の変更・キャンセルの処理も行え、顧客情報の管理も行えます。</li>
          </ul>
    
          <input type="checkbox" id="menu_bar02"/>
          <label for="menu_bar02">Ｑ2. どんなふうに予約が行われますか？</label>
          <ul id="links02" class="question-btn">
            <li><span class="answer">Ａ</span>　 予約ページから「予約する」ボタンをクリックすると、予約したい「日にち」「時間」「予約人数」の選択画面となり、次にお客様情報として「お名前」「お名前（フリガナ）」「電話番号」「メールアドレス」を入力していただき、内容確認をしてから「予約する」ボタンをクリックすると予約完了となります。<br>
            実際に作成された予約デモページをご覧になっていただくのが分かりやすいかと思いますので、以下のデモページをご覧ください。<br>
          ...
          <ul id="links08">
            ...
            予約をされた方は、顧客情報として管理されます。顧客情報は、管理画面メニューの「顧客一覧」をクリックすると確認することができ、「予約予定日」「予約対象」「お名前」「フリガナ」「電話番号」「メールアドレス」が表示されます。<br>
            検索機能によって予約予定日や予約対象、顧客情報を絞って検索することもできます。<br>
          ...
          <ul id="links12">
            <li><span class="answer">Ａ</span>　 会員登録は<a href="{{ route('register') }}">新規会員登録フォーム</a>から必要項目を入力して行い、まずは仮会員登録の状態となります。<br>
            仮会員登録の状態では管理画面を表示することはできず、管理画面を表示するには本会員登録が必要となります。<br><br>
            ...
            仮会員登録が完了すると、会員登録でご入力いただいたメールアドレスにご本人確認用のメールが送られます。メール本文内の「メールアドレス確認」をクリックすると本会員登録が完了となり、管理画面が表示されます。
              ...
              <img class="browser" src="{{ asset('img/browser.jpg')}}" alt="各ブラウザ"><br>
          ...
          <ul id="links21">
            ...
            ただし、予約完了ページと、予約をされた方に自動送信される予約完了メールには「ご予約に関してのお問い合わせは、以下の連絡先までご連絡ください。」という表記があり、お問い合わせ先は会員登録で設定されている「企業名・屋号名・団体名」「電話番号」「メールアドレス」が統一して表記されます。<br>
